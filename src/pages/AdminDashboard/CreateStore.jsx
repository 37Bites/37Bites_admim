          ...
          {steps.map((label, index) => {
            ...
            return (
              <div
                key={index}
                onClick={() =>
                  stepNumber < step && setStep(stepNumber)
                }
...
function UploadCard({ title }) {
  return (
    <div className="border-2 border-dashed border-orange-300 rounded-xl p-10 text-center cursor-pointer hover:bg-orange-50 transition">
